...
The Bootstrap package contains 3 folders and several files. 
...
In the navigation widget templates (e.g. `/Bootstrap/MVC/Views/Navigation/NavigationView.Horizontal.cshtml`) there is a helper method 
